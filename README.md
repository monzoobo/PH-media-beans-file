...
<ins>Credits :</ins>
  - Amber Chent-shi / Monzoobo, main contributor on the template and vectorial files + PHR, creator of this sorting project ;
  - Maximilian Azendorf, EVE ships' SVG files (see : https://github.com/MaximilianAzendorf/eve-ships) ;
  - quimms, former sig leader,she had started a similar project of which this one is the spiritual heir, she also sorted most of the rasterized pictures coming from the game engine ;
  - to be continued...
